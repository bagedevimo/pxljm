...
public class Triangle {
	...
	public Triangle(Point[] points, double[] heights, Biome b) {
		...
		for (int i = 0; i < 3; i++) {
			ver[i] = new Vec3(points[i].x, heights[i], points[i].y);
		}

		Vec3 normal = Vec3.planeNorm(ver[0], ver[1], ver[2]);
	...
	public boolean contains(Point p) {
		return ((ver[0].x - ver[1].x) * (p.y - ver[0].z)
				- (ver[0].z - ver[1].z) * (p.x - ver[0].x) >= 0
				&& (ver[1].x - ver[2].x) * (p.y - ver[1].z)
						- (ver[1].z - ver[2].z) * (p.x - ver[1].x) >= 0 && (ver[2].x - ver[0].x)
				* (p.y - ver[2].z) - (ver[2].z - ver[0].z) * (p.x - ver[2].x) >= 0);
	}
	...
	public boolean contains(double x, double z) {
		return ((ver[0].x - ver[1].x) * (z - ver[0].z) - (ver[0].z - ver[1].z)
				* (x - ver[0].x) >= 0
				&& (ver[1].x - ver[2].x) * (z - ver[1].z)
						- (ver[1].z - ver[2].z) * (x - ver[1].x) >= 0 && (ver[2].x - ver[0].x)
				* (z - ver[2].z) - (ver[2].z - ver[0].z) * (x - ver[2].x) >= 0);
	}

	/**
	 * Returns the interpolated value for the given point (assuming it's inside
	 * the triangle) using barycentric gibberish.
	 */
	public double height(Point p) {
		double dT = (ver[1].z - ver[2].z) * (ver[0].x - ver[2].x)
				+ (ver[2].x - ver[1].x) * (ver[0].z - ver[2].z);

		double a1 = ((ver[1].z - ver[2].z) * (p.x - ver[2].x) + (ver[2].x - ver[1].x)
				* (p.y - ver[2].z))
				/ dT;
		double a2 = ((ver[2].z - ver[0].z) * (p.x - ver[2].x) + (ver[0].x - ver[2].x)
				* (p.y - ver[2].z))
				/ dT;
		double a3 = 1 - a1 - a2;
	...
	public double height(double x, double z) {
		...
		double a1 = ((ver[1].z - ver[2].z) * (x - ver[2].x) + (ver[2].x - ver[1].x)
				* (z - ver[2].z))
				/ dT;
		double a2 = ((ver[2].z - ver[0].z) * (x - ver[2].x) + (ver[0].x - ver[2].x)
				* (z - ver[2].z))
				/ dT;
		double a3 = 1 - a1 - a2;
